  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {sidebarOpen && (
          <motion.div
            ...
            className={`fixed md:hidden z-20 md:z-0 w-2/3 md:w-1/5 h-full md:h-screen ${
              theme === "dark" ? "bg-gray-800" : "bg-white"
            ...
            <div className="flex flex-col h-full">
              ...
              >
                <div className="flex items-center">
                  <Shield className="h-8 w-8 text-blue-600" />
                  <span
                    className={`ml-2 text-xl md:text-2xl font-bold ${
                      theme === "dark" ? "text-white" : "text-gray-900"
                    } `}
                  >
                    AuthShield
      ...
      >
        ...
        {/* Main Content */}
        <main className="max-w-7xl mx-auto py-56 md:py-40 px-4 md:px-20">
          <motion.div
          ...
          >
            ...
            >
              <div className="md:px-16 py-20 text-center">
                ...
                >
                  Your account is protected with our real-time threat detection
                  system.
                </p>
              </div>
            </div>
